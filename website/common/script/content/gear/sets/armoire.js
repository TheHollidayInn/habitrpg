...
let armor = {
  ...
  minerOveralls: {
    ...
    // value: 100,
    text: t('comedArmorArmoireMinerOverallsText'),
    notes: t('comedArmorArmoireMinerOverallsNotes', { con: 10 }),
    value: 5,
    con: 10,
    set: 'miner',
  ...
  graduateRobe: {
    ...
    // value: 100,
    text: t('comedArmorArmoireGraduateRobeText'),
    notes: t('comedArmorArmoireGraduateRobeNotes', { int: 10 }),
    value: 5,
    int: 10,
    set: 'graduate',
  ...
  redPartyDress: {
    ...
    // value: 100,
    text: t('comedArmorArmoireRedPartyDressText'),
    notes: t('comedArmorArmoireRedPartyDressNotes', { attrs: 7 }),
    value: 15,
    str: 7,
    con: 7,
    int: 7,
...
let head = {
  ...
  redHairbow: {
    ...
    text: t('comedHeadArmoireRedHaribowName'),
    notes: t('comedHeadArmoireRedHaribowDesc', { str: 5, int: 5, con: 5 }),
    // value: 100,
    value: 5,
    str: 5,
    int: 5,
  ...
  blueHairbow: {
    ...
    // value: 100,
    text: t('comedHeadArmoireBlueHairbowText'),
    notes: t('comedHeadArmoireBlueHairbowNotes', { per: 5, int: 5, con: 5 }),
    value: 5,
    per: 5,
    int: 5,
    con: 5,
  ...
  goldenLaurels: {
    ...
    // value: 100,
    text: t('comedHeadArmoireGoldenLaurelsText'),
    notes: t('comedHeadArmoireGoldenLaurelsNotes', { attrs: 8 }),
    value: 10,
    per: 8,
    con: 8,
    set: 'goldenToga',
  ...
  yellowHairbow: {
    ...
    // value: 100,
    text: t('comedHeadArmoireYellowHairbowText'),
    notes: t('comedHeadArmoireYellowHairbowNotes', { attrs: 5 }),
    value: 5,
    int: 5,
    per: 5,
    str: 5,
  ...
  redFloppyHat: {
    ...
    // value: 100,
    text: t('comedHeadArmoireRedFloppyHatText'),
    notes: t('comedHeadArmoireRedFloppyHatNotes', { attrs: 6 }),
    value: 3,
    con: 6,
    int: 6,
    per: 6,
  ...
  minerHelmet: {
    ...
    // value: 100,
    text: t('comedHeadArmoireMinerHelmetText'),
    notes: t('comedHeadArmoireMinerHelmetNotes', { int: 5 }),
    value: 6,
    int: 5,
    set: 'miner',
  ...
  graduateCap: {
    ...
    // value: 100,
    text: t('comedHeadArmoireGraduateCapText'),
    notes: t('comedHeadArmoireGraduateCapNotes', { int: 9 }),
    value: 5,
    int: 9,
    set: 'graduate',
  ...
  crownOfHearts: {
    ...
    // value: 100,
    text: t('comedHeadArmoireCrownOfHeartsText'),
    notes: t('comedHeadArmoireCrownOfHeartsNotes', { str: 13 }),
    value: 3,
    str: 13,
    set: 'queenOfHearts',
...
let shield = {
  ...
  mysticLamp: {
    ...
    // value: 100,
    text: t('comedShieldArmoireMysticLampText'),
    notes: t('comedShieldArmoireMysticLampNotes', { per: 15 }),
    value: 5,
    per: 15,
  ...
  floralBouquet: {
    ...
    // value: 100,
    text: t('comedShieldArmoireFloralBouquetText'),
    notes: t('comedShieldArmoireFloralBouquetNotes', { con: 3 }),
    value: 5,
    con: 3,
...
let weapon = {
  ...
  habiticanDiploma: {
    ...
    // value: 100,
    text: t('comedWeaponArmoireHabiticanDiplomaText'),
    notes: t('comedWeaponArmoireHabiticanDiplomaNotes', { int: 11 }),
    value: 2,
    int: 11,
    set: 'graduate',
  ...
  wandOfHearts: {
    ...
    // value: 100,
    text: t('comedWeaponArmoireWandOfHeartsText'),
    notes: t('comedWeaponArmoireWandOfHeartsNotes', { int: 13 }),
    value: 3,
    int: 13,
    set: 'queenOfHearts',
