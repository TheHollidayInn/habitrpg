...
habitrpg.controller("HeaderCtrl", ['$scope', 'Groups', 'User',
  function($scope, Groups, User) {
    ...
    function resortParty() {
      var membersExceptUser = _.filter($scope.party.members, function(member) {
        return member._id !== User.user._id;
      });

      var result = _.sortBy(membersExceptUser, getUserStats);
